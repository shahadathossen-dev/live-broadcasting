    ...
    */
    ...
    'recorders' => [
        ...
        ReverbConnections::class => [
            'enabled' => env('REVERB_USER_REQUESTS_ENABLED', true),
            'sample_rate' => env('REVERB_USER_REQUESTS_SAMPLE_RATE', 1),
        ],

        ReverbMessages::class => [
            'enabled' => env('REVERB_MESSAGE_REQUESTS_ENABLED', true),
            'sample_rate' => env('REVERB_MESSAGE_REQUESTS_SAMPLE_RATE', 1),
        ],
    ],
];
